...
export const step4TransformUsersInResponse = (callback: (err: ErrorInterface, statusCode: number, nowStepsResults: StepsResultGetUsersList) => void,
                                              stepsResults: StepsResultGetUsersList) => {
  transformUsersInResponse(usersResponse => {
    stepsResults.step3TransformUsersInResponse = usersResponse;
