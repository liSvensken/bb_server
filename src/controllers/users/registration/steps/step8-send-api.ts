...
export const step8SendApi = (callback: (err: ErrorInterface, statusCode: number, result: UserRegistrationResponse) => void,
                             stepsResults: StepsResultRegistration) => {
  callback(null, 200, stepsResults.step7CreateUser);
}
